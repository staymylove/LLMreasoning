...
file_path = '/data/zeju/LLMreasoning/output_results_data/results_part_7.json/math-aps-v2.jsonl'
output_file_path = '/data/zeju/LLMreasoning/output_results_data/results_part_7.json/training_dataset.jsonl'
