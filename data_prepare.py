...
# Example usage
file_path = '/data/zeju/reasoning/output_results_data/results_part_8.json/training_dataset.jsonl'
output_file_path = '/data/zeju/reasoning/output_results_data/results_part_8.json/training_dataset_new.jsonl'
